...
lazy_static::lazy_static! {
    static ref TEST_FILE_2: &'static str = include_str!("../2m");
    static ref TEST_FILE_50: &'static str = include_str!("../50m");
}

fn bench_hashmap_std_2(mut hashmap: HashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_2.clone(), 1069);
}

fn bench_hashmap_fnv_2(mut hashmap: FnvHashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_2.clone(), 1069);
}

fn bench_hashmap_rustc_hash_2(mut hashmap: rustc_hash::FxHashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_2.clone(), 1069);
}

fn bench_hashmap_ccl_2(hashmap: dashmap::DashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_2.clone(), 1069);
}

fn bench_hashmap_std_50(mut hashmap: HashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_50.clone(), 1069);
}

fn bench_hashmap_fnv_50(mut hashmap: FnvHashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_50.clone(), 1069);
}

fn bench_hashmap_rustc_hash_50(mut hashmap: rustc_hash::FxHashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_50.clone(), 1069);
}

fn bench_hashmap_ccl_50(hashmap: dashmap::DashMap<&str, u64>) {
    hashmap.insert(TEST_FILE_50.clone(), 1069);
}
